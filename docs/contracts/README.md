...
| [food-resolution-ranking.md](food-resolution-ranking.md) | FDC candidate-ranking and common-portion rules of `food-resolution.md` (FTY-254 compatibility gate + preference ordering, FTY-326 rejection/miss boundary, cache rank stability, FTY-254/FTY-418 common-portion table, FTY-368 composed-dish decline) |
